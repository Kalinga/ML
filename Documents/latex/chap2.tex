...
Although simple, it has been demonstrated that this activation function enables better performance in deeper networks compared to widely used complex \textit{sigmoid} and \textit{hyperbolic tangent}.
...
TODO  describe object localization using sliding window, scale, pyramid and exist superior methods
