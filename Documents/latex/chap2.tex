...
Where \textit{U} is the input weight matrix and \textit{V} is the recurrent outputs. Time stamp denoted by \textit{t}. If we unfold the above equation and go back three time step we have,
