...
\node (0) [below=10mm of start]{Image data is prepared with data augmentation}; 
...
\node (7) [below=10mm of 6]{ Validate and save the neural network model}; 
\node[rounded corners=.55cm] (end) [below=15mm of 7]  {END};
