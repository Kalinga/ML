...
Consider the vehicle speed \textit{v}, the displacement of the point \textit{P} on the image is given by
...
d = \frac{w \times f}{p}
\end{equation}
where d is the distance between camera and object, w corresponds to width of the object, f represents the focal length of the camera and ${w_1}$, ${h_1}$ are the perceived width and height in the image respectively.
So with a moving camera, modified perceived width given by

\begin{equation}
\begin{array}{l@{}} 
{w_1} = \frac{w \times f}{d_{\hat{t}}} \\
{h_1} = \frac{h \times f}{d_{\hat{t}}}
\end{array}
\end{equation}
