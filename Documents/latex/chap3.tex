...
\end{align*}
\begin{center}
\caption{LSTM schematic diagram, source:Christopher Olah blog}
\end{center}
\end{figure} 
...
To aid the LSTM cell refinement. Assuming the vehicle from a constant distance from a virtual point on the x-axis in the image frame of reference.
...
%Where $\hat{\theta}$ is the final angle between vehicle and pedestrian.

%If the vehicle starts to move with an angle ${\theta }_f$ 
%\begin{equation}
%\begin{array}{l@{}}
%\theta =\hat{\theta } + {\theta }_f\\
%\end{array}			
...
%Where ${\theta }$ is the resultant angle due to vehicle change in direction.
