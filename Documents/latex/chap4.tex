...
conf1: model with epochs = 5000, MinMaxScaler(feature\textunderscore range=(0, 1)), 
...
conf2: With the below information from JAAD team, i decided to model the data using videos 71-346.
