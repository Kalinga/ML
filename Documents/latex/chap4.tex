...
NOTE:The above equations holds true for both the objects in a single frame of reference. However in our case the pedestrian bounding box is captured using camera frame of reference. And car and pedestrian actually moves in ground plane. So more investigation is still needed.
%--------AS IS---------------
