...
For the SSD model, 0.0005 is used as L2 regularization factor. The model is trained for different number of epochs(300). A customized loss function is used. Adaptive Moment Estimation (adam) is used as the optimizer with below parameters.
\begin{itemize}
