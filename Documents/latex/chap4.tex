...
\begin{algorithm}[H]
\SetAlgoLined
\KwResult{$train_X, val_X$: training and validation sequences for the model }
...
80 percentage of the prepared data is stored into $train_X$\;
20 percentage of the prepared data is stored into $val_X$\;
 \caption{Algorithms for BB data preparation}
\end{algorithm}
